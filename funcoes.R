...
#------------ funcao para remover espaços, caracteres especiais e convertê-los para minúsculo --------------
...
# ------------------- função que agrega as outras duas acima para remover acento e substituir espaços
#-------------------- e caracteres especiais e as converter em minúsculas.
...
# -------------------------- funcão para normalizar as grandes areas ---------
